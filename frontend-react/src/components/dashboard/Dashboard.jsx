...
const Dashboard = () => {
    ...
    const handleSubmit = async (e) =>{
        ...
        try{
            ...
            console.error('Error response:', error.response); // Logs the response from the server (if available)
            console.error('Error message:', error.message); // Logs the error message (if available
        }finally{
            setLoading(false);
        }
    }
